...
# In part two, the question asks to find to extrapolate the values of the series
# backwards as well, this is the same as reversing the series and then finding
# the next element.
series = [list(map(int, reversed(line.split(' ')))) for line in lines]
